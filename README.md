...
- SQL Oracle — consultas, relatórios, administração
- Dashboards Power BI — indicadores e métricas
- Business Intelligence — suporte à tomada de decisão
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,js,ts,php,java,html,css" />
</p>
...
| Projeto | Descrição |
|----------|------------|
| [Academia Fit](https://github.com/meaeduarda/AcademiaFit) | Website institucional com Next.js, React e TypeScript. |
| [Cronos Solutions](https://github.com/meaeduarda/cronossolutions) | Website institucional para serviços de tecnologia e desenvolvimento web. |
...
- Back-end com PHP, Node.js e APIs REST
- HTML/CSS, Bootstrap e design responsivo
